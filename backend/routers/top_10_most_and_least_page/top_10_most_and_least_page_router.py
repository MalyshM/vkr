...
@top_10_most_and_least_page_router.get('/api/top_10_most_and_least', name='Plot:plot', status_code=status.HTTP_200_OK,
                                       description=
                                       """
    ...
    if is_group_by:
        ...
        match type_group_by:
            case 0:
                ...
                group_by = 'group by top_10.team_id,top_10.name, top_10.lesson_counter'
            ...
            case 2:
                query_field = ',top_10.teacher_id'
                sub_query_field = ",(SELECT t.name FROM teacher t WHERE t.id = l.teacher_id) AS teacher_id"
                group_by = 'group by top_10.teacher_id,top_10.name, top_10.lesson_counter'
